...
klines1 = client.get_historical_klines("LTCUSDT", Client.KLINE_INTERVAL_1DAY, "1 Jun, 2017", "30 Dec, 2020")
klines2 = client.get_historical_klines("ETHUSDT", Client.KLINE_INTERVAL_1DAY, "1 Jun, 2017", "30 Dec, 2020")
klines3 = client.get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_1DAY, "1 Jun, 2017", "30 Dec, 2020")
klines4 = client.get_historical_klines("EOSUSDT", Client.KLINE_INTERVAL_1DAY, "1 Jun, 2017", "30 Dec, 2020")
...
positions=pd.DataFrame(np.tile(numUnits.values, [1, 4]) * ts.add_constant(-hedgeRatio)[:, [1,1,1,1]] *df.values) #  [hedgeRatio -ones(size(hedgeRatio))] is the shares allocation, [hedgeRatio -ones(size(hedgeRatio))].*y2 is the dollar capital allocation, while positions is the dollar capital in each ETF.
