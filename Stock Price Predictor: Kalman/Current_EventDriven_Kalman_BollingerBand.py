...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 29 15:01:26 2021
...
def run():
    ...
    asset1 = bt.feeds.YahooFinanceData(dataname="AAL", fromdate = startdate, todate = enddate, reverse = False)
    asset2 = bt.feeds.YahooFinanceData(dataname="LUV", fromdate = startdate, todate = enddate, reverse = False)

    cerebro.adddata(asset1)
    cerebro.adddata(asset2)
